...
> 코드 블럭은 작성한 코드틀 정리하거나 강조하고 싶은 부분을 나타날 때 사용합니다. 인라인과 단위로 구분 할 수 있습니다. 

- Inline 
  - 인라인 블럭으로 처리하고 싶은 부분을 **`** (백틱)으로 감싸줍니다.
- Block
  - **`** 을 3번 입력하고 `Enter` 를 눌러 생성합니다.
...
![](C:\Users\student\Desktop\git.png)  ![](C:\Users\student\Desktop\github.png)
...
[github 공식문서](https://gist.github.com/ihoneymon/652be052a0727ad59601) 
